...
const { analyzeIngredients, containsFortifiedVitamins, containsNaturalColorants } = require('./rulesEngine');
...
describe('6. Longest-match and overlap prevention', () => {
  ...
  test('"modified food starch" wins over "modified starch"', () => {
    ...
    // scope to conventional_crops only — GLUTEN_GRAINS intentionally double-fires
    const modFlags = flagsFor(result, 'conventional_crops').filter(
...
describe('18 — Session 4: high-oleic soybean, mustard seed oil, malt syrup, glycerol, fortification, flavouring, Spanish', () => {
  ...
  test('"niacinamide" does NOT trigger an additives flag (moved to FORTIFIED_VITAMINS)', () => {
...
describe('19 — Session 5: B-vitamin fortification, sodium preservatives, soybean, malt derivatives, rice, soya lecithin', () => {
  ...
  test('"riboflavin" does NOT trigger an additives flag (moved to FORTIFIED_VITAMINS)', () => {
...
describe('I — Sina gluten expansion: new GLUTEN_GRAINS entries', () => {
  ...
  test('"self-rising flour" — gluten_grains caution', () => {
  ...
  test('"tipo 00 flour" — gluten_grains caution', () => {
  ...
  test('"pearl barley" — gluten_grains caution', () => {
  ...
  test('"barley flour" — gluten_grains caution', () => {
  ...
  test('"pumpernickel" — gluten_grains caution', () => {
  ...
  test('"cereal rye" — gluten_grains caution', () => {
  ...
  test('"steel-cut oats" — gluten_grains caution', () => {
  ...
  test('"oat groats" — gluten_grains caution', () => {
  ...
  test('"hydrolyzed vegetable protein" — gluten_grains caution', () => {
  ...
  test('"pregelatinized starch" — gluten_grains caution', () => {
  ...
  test('"miso" — gluten_grains caution', () => {
